    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                QtonzAd.getInstance().getInterstitialAds(MainActivity.this, BuildConfig.ad_interstitial_splash, new AdCallback() {
                    @Override
        ...
        btnShow.setOnClickListener(v -> QtonzAd.getInstance().forceShowInterstitial(MainActivity.this, mInterstitialAd, new AdCallback() {
        }, true));
